#https://github.com/prajwalgatti/openai-gym-frozen-lake-solution
...
for episode in tqdm(range(total_episodes)):
	...
	for step in range(max_steps):
		...
		# prediction = qtable[state, action]
		# target = reward + gamma * np.max(qtable[new_state, :])
		# qtable[state, action] = prediction + learning_rate * (target - prediction)
